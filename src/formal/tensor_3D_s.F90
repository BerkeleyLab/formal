...
contains
  ...
  module procedure tensor_3D_conformable
    ...
    call_julienne_assert(.all. (self%x_min_ .approximates.   tensor_3D%x_min_ .within. 0E0))
    call_julienne_assert(.all. (self%x_max_ .approximates.   tensor_3D%x_max_ .within. 0E0))
    conformable = .true.
  end procedure
